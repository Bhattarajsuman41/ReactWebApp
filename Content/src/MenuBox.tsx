        ...
        var menuList = menus.map(function (menu) {
            return (
                <div key={menu.Id}>
                    ...
                    <div><span id="price">${menu.Price}</span> | <a href='#' onClick={this.addToCart.bind(this, menu.Id)} >Add to cart</a></div><hr />
                </div>
            )
        }, this);
            ...
            return (
                <div key={menu.Id}>
                   ...
                   Price: ${menu.Price * menu.Quantity}<br />
                    | <a href='#' id="removeOrder" onClick={this.removeFromCart.bind(this, cartItemIndex++)} >remove</a>
                    <hr />
                </div>
